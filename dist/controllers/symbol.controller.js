...
export class SymbolCtr {
    ...
    getSymbolsByDataSource = async (req, res) => {
        try {
            ...
            const symbols = await this.symbolService.getSymbolsByDataSource(dataSourceId);
            res.status(200).json({
                success: true,
                count: symbols.length,
                data: symbols,
...
//# sourceMappingURL=symbol.controller.js.map