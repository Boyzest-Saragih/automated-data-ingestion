...
export class ProcessedDataCtr {
    ...
    getLatestCandle = async (req, res) => {
        try {
            ...
            const candle = await this.processedDataService.getLatestCandle(String(symbol), String(granularity));
            if (!candle) {
                res.status(404).json({
                    success: false,
...
//# sourceMappingURL=processed-data.controller.js.map